                     ...
                     for (var pos1 : positions.get(k)) {
                         for (var pos2 : positions.get(k)) {
                             if (pos1 == pos2) {
                                 ...
                                 int[] res1 = new int[]{pos2.getItem1() + diff[0], pos2.getItem2() + diff[1]};
                                 if(res1[0] >= 0 && res1[0] < map.size() && res1[1] >= 0 && res1[1] < map.get(0).size()) {
                                     found.add(Tuple2.of(res1[0], res1[1]));
                                 }
                                 int[] res2 = new int[]{pos1.getItem1() - diff[0], pos1.getItem2() - diff[1]};
                                 if(res2[0] >= 0 && res2[0] < map.size() && res2[1] >= 0 && res2[1] < map.get(0).size()) {
